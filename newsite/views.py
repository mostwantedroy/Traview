...
def browse(request):
    ...
    view = [
        'thrill', 'skyscrapers', 'skyscraper', 'pretty', 'upper', 'wide', 'artistic', 'serene', 'ultra',
    ...
    valuation = [
        'extraordinary', 'tough', 'ideal', 'innovative', 'historic', 'reachable', 'quintessential', 'fantastic',
        'pleasant', 'recommended', 'typical', 'eastern', 'impressive', 'horrible', 'unique', 'psychedelic', 'wooden',
        'incredible', 'trippy', 'thoughtful', 'vigorous', 'accessible', 'rare', 'hot', 'gorgeous', 'satisfied', 'awful',
        'unbelievable', 'happy', 'local', 'unforgettable', 'photogenic', 'disappointed', 'friendly', 'modern', 'nice',
        'ceremonial', 'archaeological', 'energetic', 'great', 'brilliant', 'convenient', 'romantic', 'approachable',
